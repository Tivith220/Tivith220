...
<!-- Replace Tivith220 everywhere with your handle -->
<!-- ================================================= -->
...
> ⚠️ Idhu **real moving animation** — 3 min setup venum (steps kadaisila irukku)
...
<!--
🟡 PAC-MAN SETUP STEPS (for the live moving animation above):
1. Unga profile repo (Tivith220/Tivith220) la .github/workflows/pacman.yml file create pannunga
2. Adhula kீழe kudutha code paste pannunga:
...
3. Commit pannunga, Actions tab la run aagum
4. Konjam nera kalichi README la Pac-Man animation live varum
-->
